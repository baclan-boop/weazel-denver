...
// Просмотр — доступен Advertising Department и выше (Старший состав AD, Редактор,
...
router.put('/contracts/:id', requireAdvertising, async (req, res) => {
  try {
    ...
    // Старший состав AD и выше. Им доступны только статус, «Откинул» и время переноса.
...
// Старший состав AD и выше, см. POST /api/contracts/pending/:id/approve ниже —
...
// ═══════════════════════════════════════════════════════════════════════
// ОДОБРЕНИЕ ЗАЯВОК НА ДОБАВЛЕНИЕ КОНТРАКТА (Старший состав AD и выше)
// ═══════════════════════════════════════════════════════════════════════
...
// (создание/редактирование/удаление) по-прежнему только Старший состав AD и выше
